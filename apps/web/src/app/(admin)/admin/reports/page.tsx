              ...
              <Paper sx={{ p: 3 }}>
                ...
                <Grid container spacing={2}>
                  {[
                    ...
                    { label: 'Gastos en efectivo', value: formatCurrency(report.finance.cashExpense), color: 'error.main' },
                    { label: 'Gastos virtuales', value: formatCurrency(report.finance.virtualExpense), color: 'error.main' },
