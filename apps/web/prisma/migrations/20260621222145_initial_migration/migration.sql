...
-- CreateEnum
CREATE TYPE "OrderStatus" AS ENUM ('RECIBIDO', 'CONFIRMADO', 'PREPARANDO', 'EN_HORNO', 'LISTO', 'EN_REPARTO', 'ENTREGADO', 'CANCELADO');
...
CREATE TABLE "ShipmentZone" (
    ...
    CONSTRAINT "ShipmentZone_pkey" PRIMARY KEY ("id")
);
...
CREATE TABLE "WhatsAppToken" (
    ...
    CONSTRAINT "WhatsAppToken_pkey" PRIMARY KEY ("id")
);
...
-- CreateIndex
CREATE INDEX "Promotion_available_idx" ON "Promotion"("available");
...
-- CreateIndex
CREATE UNIQUE INDEX "WhatsAppToken_token_key" ON "WhatsAppToken"("token");

-- CreateIndex
CREATE INDEX "WhatsAppToken_token_idx" ON "WhatsAppToken"("token");

-- CreateIndex
CREATE INDEX "WhatsAppToken_phone_idx" ON "WhatsAppToken"("phone");

-- CreateIndex
CREATE INDEX "WhatsAppToken_expiresAt_idx" ON "WhatsAppToken"("expiresAt");
...
-- AddForeignKey
ALTER TABLE "DeliveryFee" ADD CONSTRAINT "DeliveryFee_shipmentZoneId_fkey" FOREIGN KEY ("shipmentZoneId") REFERENCES "ShipmentZone"("id") ON DELETE SET NULL ON UPDATE CASCADE;
